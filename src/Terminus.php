...
class Terminus implements ConfigAwareInterface, ContainerAwareInterface, LoggerAwareInterface
{
    ...
    private function addBuiltInCommandsAndHooks()
    {
        ...
        $this->commands = [
            ...
            'Pantheon\\Terminus\\Commands\\Plugin\\InstallCommand',
            'Pantheon\\Terminus\\Commands\\Plugin\\SearchCommand',
            'Pantheon\\Terminus\\Commands\\Plugin\\ShowCommand',
            'Pantheon\\Terminus\\Commands\\Plugin\\UninstallCommand',
            'Pantheon\\Terminus\\Commands\\Plugin\\UpdateCommand',
